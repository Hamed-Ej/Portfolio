export default function ZahedanMap() {
  return (
    <div className="w-full h-64 overflow-hidden border border-gray-200 dark:border-transparent grayscale contrast-125" style={{ contentVisibility: "auto", containIntrinsicSize: "auto 256px" }}>
      <iframe
